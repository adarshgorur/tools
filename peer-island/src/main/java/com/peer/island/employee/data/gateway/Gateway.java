package com.peer.island.employee.data.gateway;

import java.util.Scanner;
import org.apache.log4j.Logger;
import com.peer.island.employee.data.process.CommandArgument;
import com.peer.island.employee.data.process.CommandFactory;
 ...
 * @author adarsh
 * 
 * This class triggers the cli for reading,displaying,adding and deleting employee data from XML
 *
 */
...
public class Gateway {
	...
	public static void main(String[] args) {
		...
		// add --file=C:\eclipse-project\peer-island\input\employee_data.xml --name=adarsh --age=25 --designation=staff_engineer
